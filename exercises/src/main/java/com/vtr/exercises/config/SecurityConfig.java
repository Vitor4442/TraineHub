...
import com.vtr.exercises.security.jwt.JwtTokenFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests -> authorizeHttpRequests.requestMatchers(
                                "/auth/signin",
                                "/auth/refresh/**",
                                "/auth/createUser", //não pode fica em produção , remova apos usaar
                                "/swagger-ui/**",
                                "/swagger-ui/**",
                                "/v3/api-docs/**"
                        ).permitAll()
                                .requestMatchers("/alunos/**").authenticated()
                                .requestMatchers("/exercicios/**").authenticated()
